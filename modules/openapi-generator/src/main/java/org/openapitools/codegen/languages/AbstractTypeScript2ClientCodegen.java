...
public abstract class AbstractTypeScript2ClientCodegen extends DefaultCodegen implements CodegenConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractTypeScript2ClientCodegen.class);
    ...
    public AbstractTypeScript2ClientCodegen() {
        super();
