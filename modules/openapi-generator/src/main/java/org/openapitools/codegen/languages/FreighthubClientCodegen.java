...
public class FreighthubClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public String getHelp() {
        return "Generates a freighthub client.";
    }

    public FreighthubClientCodegen() {
        super();

        this.outputFolder = "generated-code" + File.separator + "freighthub";

        embeddedTemplateDir = templateDir = "freighthub-client";
        ...
        this.cliOptions.add(new CliOption(USE_PROMISE,
                ...
                SchemaTypeUtil.BOOLEAN_TYPE).defaultValue(Boolean.FALSE.toString()));
        this.cliOptions.add(new CliOption(USE_RXJS6, "Setting this property to use rxjs 6 instead of rxjs 5.",
                SchemaTypeUtil.BOOLEAN_TYPE).defaultValue(Boolean.FALSE.toString()));
    ...
    public void processOpts() {
        ...
        supportingFiles
                .add(new SupportingFile("IAPIConfiguration.mustache", getIndexDirectory(), "IAPIConfiguration.ts"));
        ...
        supportingFiles
                .add(new SupportingFile("ApiServiceBinder.mustache", getIndexDirectory(), "ApiServiceBinder.ts"));
